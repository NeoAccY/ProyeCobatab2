...
<section class="form-register">
    <form action="">
        ...
        <h4>Reporte de conducta</h4>
        </div>
        <input class="controls" type="text" name="matricula" id="matricula" placeholder="Matricula del Alumno">
        <label class="cont_select" for="motivo">Se reporta por:</label>
