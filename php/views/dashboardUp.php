            ...
            <div class="col-1 text-right barra">
                <ul class="navbar-nav mr-auto">
                    ...
                    <!-- Linea Modificada -->
                        ...
                        <a class="dropdown-item menuperfil cerrar" href="formNewUser.php">
                            <i class="fas fa-user-check m-1"></i>Nuevo Usuario
                        </a>
        ...
        <div class="barra-lateral col-12 col-sm-auto">
            <nav class="menu d.flex d-sm-block justify-content-center flex-wrap">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li>
                    <a href="#" class="px-3 text-light perfil dropdown-toogle" id="navbar-Dropdown" role="button" data-toogle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-toggle="dropdown">
                    <i class="fas fa-door-open m-1"></i>Accesos
                    </a> 
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                    ...
                    <i class="fas fa-comments m-1"></i>Notificaciones
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                        <a class="dropdown-item menuperfil cerrar" href="formReunion.php">
                            <i class="fas fa-users m-1"></i>Avisos
                        </a>
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                            ...
                            <a class="dropdown-item menuperfil cerrar" href="formInformativos.php">
                                <i class="fas fa-envelope-open-text m-1"></i>Informativos
                            </a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                            <a class="dropdown-item menuperfil cerrar" href="formIngresos.php">
                                <i class="fas fa-university m-1"></i>Ingresos a la institución
                            </a>
                            <a class="dropdown-item menuperfil cerrar" href="formHistReportes.php">
                                <i class="fas fa-user-tag m-1"></i>Total de Reportes
                            </a>
                    ...
                    <li>
                    <a href="#" class="px-3 text-light perfil dropdown-toogle" id="navbar-Dropdown" role="button" data-toogle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-toggle="dropdown">
                    <i class="fas fa-sitemap m-1"></i>Configuraciones
                    </a> 
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                        <a class="dropdown-item menuperfil cerrar" href="formAgregar.php">
                            <i class="fas fa-download m-1"></i>Agregar...
                        </a>
                        <a class="dropdown-item menuperfil cerrar" href="AdminDate.php">
                            <i class="fas fa-download m-1"></i>Administrar...
                        </a>
                        <a class="dropdown-item menuperfil cerrar" href="formEspecial.php">
                            <i class="fas fa-business-time m-1"></i>Especialidades...
                        </a>
                        </div>
                    </li>
                </ul>
